	...
	if (isset($_SESSION['username']) && ($_SESSION['password']))
	{
		...
		else
		{
			...
			if ($valid_nama_acara && $valid_tanggal && $valid_waktu_mulai && $valid_waktu_selesai && $valid_tempat)
			{
				...
				edit_pendidikan($id_jadwal,$nama_acara,$tanggal,$waktu_mulai,$waktu_selesai,$tempat,$keterangan);
			}
		}
?>
    ...
    <div id="wrapper">
		...
		<div id="page-wrapper" >
            <div id="page-inner">
				...
				<div class="row">
					<div class="col-md-12">
						<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?id_jadwal='.$id_jadwal;?>" method="post" enctype="multipart/form-data"/>
