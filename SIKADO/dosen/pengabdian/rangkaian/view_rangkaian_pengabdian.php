...
<head>
	...
	function Konf1(z)
	{
		...
		if (result)
		{
			document.location = "delete_rangkaian_pengabdian.php?id="+z;
		}
	}
	</script>
</head>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Rangkaian Kegiatan Pengabdian <?php echo $nama_pengabdian; ?></h2>
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
				 <a href="add_rangkaian_pengabdian.php?id=<?php echo $id?>" class = "btn btn-outline btn-default" style="float: left"><i class="fa fa-plus fa-fw"></i> Tambah Rangkaian Pengabdian </a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             Rangkaian Pengabdian <?php echo $nama_pengabdian; ?>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php view_rangkaian_pengabdian($nip,$id); ?>
                                </table>
                            </div>
			...
			<p><a href="../view_pengabdian.php" class = "btn btn-danger" style="float: left"><i class="fa fa-arrow-circle-left fa-fw"></i>&nbsp Kembali </a></p>
