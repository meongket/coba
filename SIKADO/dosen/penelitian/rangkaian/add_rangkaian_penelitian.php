	...
	if (isset($_SESSION['username']) && ($_SESSION['password']))
	{
		...
		if (isset($_POST["submit"]))
		{
			...
			if ($valid_nama_acara && $valid_tanggal && $valid_waktu_mulai && $valid_waktu_selesai && $valid_tempat)
			{
				...
				add_rangkaian_penelitian($nip,$nama_acara,$tanggal,$waktu_mulai,$waktu_selesai,$tempat,$id_penelitian,$keterangan);
			}
		}
?>
    ...
    <div id="wrapper">
		...
		<div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Tambah Rangkaian Kegiatan Penelitian <?php echo $nama_penelitian; ?></h2>
				...
				<div class="row">
					<div class="col-md-12">
						<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?id='.$id_penelitian;?>" method="post" enctype="multipart/form-data"/>
