<?php
	...
	if (isset($_SESSION['username']) && ($_SESSION['password']))
	{
		...
		$query = "SELECT * FROM penelitian WHERE id_penelitian = '".$id_penelitian."'";
		$result = $db->query($query);
		while ($row = $result->fetch_object())
		{
			$nama_penelitian = $row->judul;
		}
		...
		else
		{
			...
			if ($valid_nama_acara && $valid_tanggal && $valid_waktu_mulai && $valid_waktu_selesai && $valid_tempat)
			{
				...
				edit_rangkaian_penelitian($id_jadwal,$nama_acara,$tanggal,$waktu_mulai,$waktu_selesai,$tempat,$id_penelitian,$keterangan);
			}
		}
?>
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="main-menu">
					...
					<li>
						...
						<ul class="nav nav-second-level">
							...
							<li>
								<a href="../view_penelitian.php">Penelitian</a>
							</li>
							<li>
		...
		<div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Edit Rangkaian Kegiatan Penelitian <?php echo $nama_penelitian; ?></h2>
				...
				<div class="row">
					<div class="col-md-12">
							<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?id_jadwal='.$id_jadwal.'&id_penelitian='.$id_penelitian;?>" method="post" enctype="multipart/form-data"/>
							...
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"></label>
									<div class="col-sm-10">
										...
										<a href="view_rangkaian_penelitian.php?id=<?php echo $id_penelitian; ?>" class = "btn btn-outline btn-danger"><i class="fa fa-arrow-circle-left fa-fw"></i> Kembali </a>
									</div>
							</div>
