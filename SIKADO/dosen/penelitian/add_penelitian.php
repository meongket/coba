<?php
	...
	if (isset($_SESSION['username']) && ($_SESSION['password']))
	{
		...
		if (isset($_POST["submit"]))
		{
			...
			if ($sumber_dana == "" || $sumber_dana == "none")
			{
			...
			if ($valid_judul && $valid_skim && $valid_tgl_mulai && $valid_tgl_selesai && $valid_sumber_dana)
			{
				...
				add_penelitian($id_penelitian,$nip,$judul,$skim,$tgl_mulai,$tgl_selesai,$sumber_dana);
			}
		}
?>
				...
				<div class="row">
					<div class="col-md-12">
						<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data"/>
							...
							<div class="col-sm-8">
								<input type="text" name="judul" class="form-control" size="30" maxlength="200" placeholder="" value="<?php if (isset($judul)){echo $judul;}?>">
							...
							<label class="col-sm-2 col-sm-2 control-label"></label>
								<div class="col-sm-10">
									...
									<a href = "view_penelitian.php" class="btn btn-danger"><i class="fa fa-arrow-circle-left fa-fw"></i> Kembali </a>
								</div>
							</div>
						</form>
					</div>
