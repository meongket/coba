    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="main-menu">
					...
					<li>
						...
						<ul class="nav nav-second-level">
							...
							<li>
								<a class="active-menu" href="#">Penelitian</a>
							</li>
							<li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Daftar Data Penelitian</h2>

                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
				<a href="add_penelitian.php" class = "btn btn-outline btn-default" style="float: left"><i class="fa fa-plus fa-fw"></i> Tambah Penelitian</a>
				<br></br><br></br>
            <div class="row">
                <div class="col-md-12">
                    <!-- Advanced Tables -->
