	...
	if (isset($_SESSION['username']) && ($_SESSION['password']))
	{
		...
		if (isset($_POST["submit"]))
		{
			...
			if ($valid_password_baru && $valid_password_lama && $valid_konfirmasi_password)
			{
				...
				ganti_password_kadep($password_baru);
			}
		}
?>
	...
	<!DOCTYPE html>
		...
		<main>
            ...
            <div class="row">
                <div class="col-md-12">
								<center>
								<h2>Ganti Password Ketua Departemen</h2><br/>
								</center>
								<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data"/>
									<div class="form-group">
										<label class="col-sm-4 col-sm-4"> Masukkan Password Lama </label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										<label class="col-sm-4 col-sm-4"> Masukkan Password Baru </label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										<label class="col-sm-4 col-sm-4"> Konfirmasi Password Baru </label>
										<div class="col-sm-8">
									...
									<br/>
									<div class="form-group">
										<label class="col-sm-4 col-sm-4"></label>
										<div class="col-sm-6">
											<input colspan="3" type="submit" class="btn btn-outline btn-primary" name="submit" id="submit" value="Simpan" disabled />
											<a href= "../blank_kadep.php" class="btn btn-outline btn-danger"><i class="fa fa-arrow-circle-left fa-fw"></i> Kembali</a>
										</div>
									</div>
								</form>
								</div>
