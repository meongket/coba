...
<head>
   ...
   <script>
				function Konf1(z)
				{
					...
					if (result)
					{
						document.location = "delete_mahasiswa.php?id="+z;
					}
				}
			</script>
</head>
  ...
  <div class="top-nav notification-row">
				...
				<li class="text-center">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-menu" href="#">Mahasiswa</a>  
                            </li>
                        </ul>
                      </li>  
                </ul>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Daftar Mahasiswa Departemen Statistika</h2>   
                    </div>
                </div>
				<!-- /. ROW  -->
                 <hr />
				 <a href="add_mahasiswa.php" class = "btn btn-outline btn-default" style="margin-left:0px; margin-top: -50px; margin-bottom: -40px"><i class="fa fa-plus fa-fw"></i> Tambah Mahasiswa</a></p>
